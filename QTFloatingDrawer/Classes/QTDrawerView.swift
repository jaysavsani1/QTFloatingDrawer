...
open class QTDrawerView: UIView {
    
    let kQTCenterViewContainerCornerRadius: CGFloat = 5.0
    let kQTDefaultViewContainerWidth: CGFloat = 280.0
    ...
    fileprivate var leftViewWidthConstraint: NSLayoutConstraint {
        get {
            ...
            let retVal = NSLayoutConstraint(item: self.leftViewContainer, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute,  multiplier: 1.0, constant: self.kQTDefaultViewContainerWidth)
    ...
    fileprivate var rightViewWidthConstraint: NSLayoutConstraint {
        get {
            ...
            let constraint = NSLayoutConstraint(item: self.rightViewContainer, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute,  multiplier: 1.0, constant: self.kQTDefaultViewContainerWidth)
        ...
        set {
            if let view = self.centerViewContainer.subviews.first {
                if (newValue) {
                    ...
                    view.layer.cornerRadius  = kQTCenterViewContainerCornerRadius
                } else {
    ...
    func updateShadowPath() {
        ...
        layer.shadowPath = UIBezierPath(roundedRect: rect, cornerRadius: kQTCenterViewContainerCornerRadius).cgPath
    }
    
    func viewContainerForDrawerSide(_ drawerSide: QTDrawerSide) -> UIView? {
    ...
    func willOpenDrawer(_ viewController: QTDrawerViewController) {
        self.shouldRadiusCenterViewController = true
        self.shouldShadowCenterViewContainer = true
    }
    
    func willCloseDrawer(_ viewController: QTDrawerViewController) {
